...
public class RecipeDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView recipeName = (TextView) findViewById(R.id.recipe_toolbar_name);
        recipeName.setText(GlobalData.getRecipeFromList(getIntent().getStringExtra(RecipeDetailFragment.ARG_ITEM_ID)).getName());
    }
